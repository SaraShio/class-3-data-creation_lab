...
const styles = StyleSheet.create({
    ...
    customButton:{
        ...
        paddingVertical: 10,  // added some vertical padding for touch comfort
        paddingHorizontal: 20, // horizontal padding for aesthetics
        backgroundColor: '#677DB7', // moved the background color here from buttonText
        borderRadius: 5,  // added a slight radius for rounded edges
        marginBottom: 4
    },
    iconStyle: {
